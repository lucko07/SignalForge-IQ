...
import BestTradingSignalsPage from "./pages/BestTradingSignalsPage";
import CryptoTradingSignalsPage from "./pages/CryptoTradingSignalsPage";
...
import ExecutionAuditPage from "./pages/admin/ExecutionAuditPage";
import UpgradePage from "./pages/UpgradePage";
import UpgradeSuccessPage from "./pages/UpgradeSuccessPage";
import UpgradeCancelPage from "./pages/UpgradeCancelPage";
import TermsPage from "./pages/TermsPage";
import PrivacyPolicyPage from "./pages/PrivacyPolicyPage";
import TrackTradingPerformancePage from "./pages/TrackTradingPerformancePage";
  ...
  if (!hasRequiredFirebaseClientConfig) {
    return (
      <Routes>
        ...
        <Route path="/demo-terminal" element={<Navigate to="/marketing-assets" replace />} />
        <Route
          path="*"
          element={
            <main
            ...
            >
              ...
              >
                <h1 style={{ margin: 0, color: "var(--color-text-primary)" }}>SignalForge IQ</h1>
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        <Route path="/best-trading-signals" element={<BestTradingSignalsPage />} />
        <Route path="/crypto-trading-signals" element={<CryptoTradingSignalsPage />} />
        <Route path="/track-trading-performance" element={<TrackTradingPerformancePage />} />
